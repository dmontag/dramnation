module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c186 = "where",
        peg$c187 = { type: "literal", value: "where", description: "\"where\"" },
        peg$c188 = function(ast) { return {operation:"find", kind:"whisky", ast:ast}; },
        peg$c189 = "or",
        peg$c190 = { type: "literal", value: "or", description: "\"or\"" },
        peg$c191 = function(left, right) { return {kind:"or", input:[left, right]}; },
        peg$c192 = "and",
        peg$c193 = { type: "literal", value: "and", description: "\"and\"" },
        peg$c194 = function(left, right) { return {kind:"and", input:[left, right]}; },
        peg$c195 = "(",
        peg$c196 = { type: "literal", value: "(", description: "\"(\"" },
        peg$c197 = ")",
        peg$c198 = { type: "literal", value: ")", description: "\")\"" },
        peg$c199 = function(exp) { return exp; },
        peg$c200 = "not",
        peg$c201 = { type: "literal", value: "not", description: "\"not\"" },
        peg$c202 = function(exp) { return {kind:"not", input:exp}; },
        peg$c203 = function(literal) { return {kind:"is", input:literal[0]}; },
        peg$c204 = "owned",
        peg$c205 = { type: "literal", value: "owned", description: "\"owned\"" },
        peg$c206 = function() { return ["owned"]; },
        peg$c207 = function(op, wp) { 
            return {kind:(op || "="), input:wp};
          },
        peg$c208 = function(ct) { return {kind:"=", input:ct}; },
        peg$c209 = function(cf) { return {kind:"=", input:cf}; },
        peg$c210 = function(wb) { return {kind:"bottler", input:wb[1]}; },
        peg$c211 = function(op, age) {
            return {kind:(op || "="), input:age};
          },
        peg$c212 = "distilled",
        peg$c213 = { type: "literal", value: "distilled", description: "\"distilled\"" },
        peg$c214 = function(d) { return {kind:"distillery", input:["name", d]}; },
        peg$c215 = function(r) { return {kind:"region", input:r}; },
        peg$c216 = function() { return {kind:"distillery", input:["closed", true]}; },
        peg$c217 = ">",
        ...
        peg$c223 = "contains",
        peg$c224 = { type: "literal", value: "contains", description: "\"contains\"" },
        peg$c225 = function(q) { return {kind:"note", input:q}; },
        peg$c226 = /^[ \n\r\t]/,
        peg$c227 = { type: "class", value: "[ \\n\\r\\t]", description: "[ \\n\\r\\t]" },
        peg$c228 = function() { return null; },
        peg$c229 = "19",
        peg$c230 = { type: "literal", value: "19", description: "\"19\"" },
        peg$c231 = "20",
        peg$c232 = { type: "literal", value: "20", description: "\"20\"" },
        peg$c233 = /^[0-9]/,
        peg$c234 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c235 = function(n) { return parseInt(n.join(""), 10); },
        peg$c236 = /^[0123]/,
        peg$c237 = { type: "class", value: "[0123]", description: "[0123]" },
        peg$c238 = "\"",
        peg$c239 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c240 = function(s1, s2) { return s1+s2.join(""); },
        peg$c241 = function(first, rest) { var words = rest.map(function(d){return d.join("");}); words.unshift(first); return words.join(" "); },
        peg$c242 = function(s1, s2) { return s1 + s2.join(""); },
        peg$c243 = function(s) { return s.join(""); },
        peg$c244 = /^[0-9.,]/,
        peg$c245 = { type: "class", value: "[0-9.,]", description: "[0-9.,]" },
        peg$c246 = function(n) { return parseFloat(n.join("").replace(",","."), 10); },
        peg$c247 = /^[a-zA-Z0-9\-_]/,
        peg$c248 = { type: "class", value: "[a-zA-Z0-9\\-_]", description: "[a-zA-Z0-9\\-_]" },
        peg$c249 = function(id) { return id.join(""); },
        peg$c250 = /^[12]/,
        peg$c251 = { type: "class", value: "[12]", description: "[12]" },
        peg$c252 = /^[90]/,
        peg$c253 = { type: "class", value: "[90]", description: "[90]" },
        peg$c254 = "-",
        peg$c255 = { type: "literal", value: "-", description: "\"-\"" },
        peg$c256 = /^[01]/,
        peg$c257 = { type: "class", value: "[01]", description: "[01]" },
        peg$c258 = /^[a-\xF6A-\xD60-9 ,.\-':&%?]/,
        peg$c259 = { type: "class", value: "[a-\\xF6A-\\xD60-9 ,.\\-':&%?]", description: "[a-\\xF6A-\\xD60-9 ,.\\-':&%?]" },
        peg$c260 = /^[a-\xF6A-\xD6]/,
        peg$c261 = { type: "class", value: "[a-\\xF6A-\\xD6]", description: "[a-\\xF6A-\\xD6]" },
        peg$c262 = /^[a-\xF6A-\xD60-9]/,
        peg$c263 = { type: "class", value: "[a-\\xF6A-\\xD60-9]", description: "[a-\\xF6A-\\xD60-9]" },
