module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c185 = function(ast) { return {operation:"find", kind:"whisky", ast:ast}; },
        peg$c186 = "or",
        peg$c187 = { type: "literal", value: "or", description: "\"or\"" },
        peg$c188 = function(left, right) { return {kind:"or", input:[left, right]}; },
        peg$c189 = "and",
        peg$c190 = { type: "literal", value: "and", description: "\"and\"" },
        peg$c191 = function(left, right) { return {kind:"and", input:[left, right]}; },
        peg$c192 = "(",
        peg$c193 = { type: "literal", value: "(", description: "\"(\"" },
        peg$c194 = ")",
        peg$c195 = { type: "literal", value: ")", description: "\")\"" },
        peg$c196 = function(exp) { return exp; },
        peg$c197 = "not",
        peg$c198 = { type: "literal", value: "not", description: "\"not\"" },
        peg$c199 = function(exp) { return {kind:"not", input:exp}; },
        peg$c200 = function(literal) { return {kind:"is", input:literal[0]}; },
        peg$c201 = "owned",
        peg$c202 = { type: "literal", value: "owned", description: "\"owned\"" },
        peg$c203 = function() { return ["owned"]; },
        peg$c204 = function(op, wp) { 
            return {kind:(op || "="), input:wp};
          },
        peg$c205 = function(ct) { return {kind:"=", input:ct}; },
        peg$c206 = function(cf) { return {kind:"=", input:cf}; },
        peg$c207 = function(wb) { return {kind:"bottler", input:wb[1]}; },
        peg$c208 = function(op, age) {
            return {kind:(op || "="), input:age};
          },
        peg$c209 = "distilled",
        peg$c210 = { type: "literal", value: "distilled", description: "\"distilled\"" },
        peg$c211 = function(d) { return {kind:"distillery", input:["name", d]}; },
        peg$c212 = function(r) { return {kind:"region", input:r}; },
        peg$c213 = function() { return {kind:"distillery", input:["closed", true]}; },
        peg$c214 = ">",
        ...
        peg$c220 = "contains",
        peg$c221 = { type: "literal", value: "contains", description: "\"contains\"" },
        peg$c222 = function(q) { return {kind:"note", input:q}; },
        peg$c223 = /^[ \n\r\t]/,
        peg$c224 = { type: "class", value: "[ \\n\\r\\t]", description: "[ \\n\\r\\t]" },
        peg$c225 = function() { return null; },
        peg$c226 = "19",
        peg$c227 = { type: "literal", value: "19", description: "\"19\"" },
        peg$c228 = "20",
        peg$c229 = { type: "literal", value: "20", description: "\"20\"" },
        peg$c230 = /^[0-9]/,
        peg$c231 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c232 = function(n) { return parseInt(n.join(""), 10); },
        peg$c233 = /^[0123]/,
        peg$c234 = { type: "class", value: "[0123]", description: "[0123]" },
        peg$c235 = "\"",
        peg$c236 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c237 = function(s1, s2) { return s1+s2.join(""); },
        peg$c238 = function(first, rest) { var words = rest.map(function(d){return d.join("");}); words.unshift(first); return words.join(" "); },
        peg$c239 = function(s1, s2) { return s1 + s2.join(""); },
        peg$c240 = function(s) { return s.join(""); },
        peg$c241 = /^[0-9.,]/,
        peg$c242 = { type: "class", value: "[0-9.,]", description: "[0-9.,]" },
        peg$c243 = function(n) { return parseFloat(n.join("").replace(",","."), 10); },
        peg$c244 = /^[a-zA-Z0-9\-_]/,
        peg$c245 = { type: "class", value: "[a-zA-Z0-9\\-_]", description: "[a-zA-Z0-9\\-_]" },
        peg$c246 = function(id) { return id.join(""); },
        peg$c247 = /^[12]/,
        peg$c248 = { type: "class", value: "[12]", description: "[12]" },
        peg$c249 = /^[90]/,
        peg$c250 = { type: "class", value: "[90]", description: "[90]" },
        peg$c251 = "-",
        peg$c252 = { type: "literal", value: "-", description: "\"-\"" },
        peg$c253 = /^[01]/,
        peg$c254 = { type: "class", value: "[01]", description: "[01]" },
        peg$c255 = /^[a-\xF6A-\xD60-9 ,.\-':&%?]/,
        peg$c256 = { type: "class", value: "[a-\\xF6A-\\xD60-9 ,.\\-':&%?]", description: "[a-\\xF6A-\\xD60-9 ,.\\-':&%?]" },
        peg$c257 = /^[a-\xF6A-\xD6]/,
        peg$c258 = { type: "class", value: "[a-\\xF6A-\\xD6]", description: "[a-\\xF6A-\\xD6]" },
        peg$c259 = /^[a-\xF6A-\xD60-9]/,
        peg$c260 = { type: "class", value: "[a-\\xF6A-\\xD60-9]", description: "[a-\\xF6A-\\xD60-9]" },
