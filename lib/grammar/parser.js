module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c223 = "19",
        peg$c224 = { type: "literal", value: "19", description: "\"19\"" },
        peg$c225 = "20",
        peg$c226 = { type: "literal", value: "20", description: "\"20\"" },
        peg$c227 = /^[0-9]/,
        peg$c228 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c229 = function(n) { return parseInt(n.join(""), 10); },
        peg$c230 = /^[0123]/,
        peg$c231 = { type: "class", value: "[0123]", description: "[0123]" },
        peg$c232 = "\"",
        peg$c233 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c234 = function(s1, s2) { return s1+s2.join(""); },
        peg$c235 = function(first, rest) { var words = rest.map(function(d){return d.join("");}); words.unshift(first); return words.join(" "); },
        peg$c236 = function(s1, s2) { return s1 + s2.join(""); },
        peg$c237 = function(s) { return s.join(""); },
        peg$c238 = /^[0-9.,]/,
        peg$c239 = { type: "class", value: "[0-9.,]", description: "[0-9.,]" },
        peg$c240 = function(n) { return parseFloat(n.join("").replace(",","."), 10); },
        peg$c241 = /^[a-zA-Z0-9\-_]/,
        peg$c242 = { type: "class", value: "[a-zA-Z0-9\\-_]", description: "[a-zA-Z0-9\\-_]" },
        peg$c243 = function(id) { return id.join(""); },
        peg$c244 = /^[12]/,
        peg$c245 = { type: "class", value: "[12]", description: "[12]" },
        peg$c246 = /^[90]/,
        peg$c247 = { type: "class", value: "[90]", description: "[90]" },
        peg$c248 = "-",
        peg$c249 = { type: "literal", value: "-", description: "\"-\"" },
        peg$c250 = /^[01]/,
        peg$c251 = { type: "class", value: "[01]", description: "[01]" },
        peg$c252 = /^[a-\xF6A-\xD60-9 ,.\-':&%?]/,
        peg$c253 = { type: "class", value: "[a-\\xF6A-\\xD60-9 ,.\\-':&%?]", description: "[a-\\xF6A-\\xD60-9 ,.\\-':&%?]" },
        peg$c254 = /^[a-\xF6A-\xD6]/,
        peg$c255 = { type: "class", value: "[a-\\xF6A-\\xD6]", description: "[a-\\xF6A-\\xD6]" },
        peg$c256 = /^[a-\xF6A-\xD60-9]/,
        peg$c257 = { type: "class", value: "[a-\\xF6A-\\xD60-9]", description: "[a-\\xF6A-\\xD60-9]" },
